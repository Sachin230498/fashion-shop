...
//                     </header>
//                     <div className='logo'>
//                         <svg viewBox="0 0 132 55" xmlns="https://ccgprinting.in/wp-content/uploads/2022/02/cropped-blackccg-1-120x130.png">
//                             <Link to='/'>
...
//                     </Link>
//                     <div >
//                         {!isAuth ? <Link to='/login' state={{path:'/login'}}> <span>LOGIN</span></Link> : <Signout/>}
//                         <Link to="/help">
